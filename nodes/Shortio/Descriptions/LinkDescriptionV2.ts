...
export const linkFields: INodeProperties[] = [
...

	{
		...
		options: [
			...
			},
			{
				...
				name: 'cloaking',
				description:
					'Whether the link will be cloaked. Cloaked links will redirect to the original URL, but will not show the original URL in the browser address bar.',
				type: 'boolean',
				default: false,
			},
			{
			...
			},
			{
				...
				name: 'ttl',
				description:
					"The date and time when the link will delete in unix miliseconds. If not set, link will never expire. Unlike expiresAt the link will be deleted and won't be counted in account link limit. TTL can not be earlier than 1 week from the current time.",
				type: 'string',
				default: '',
				placeholder: '1714442044236',
			},
	...
	{
		displayName: 'Existing Short Link Identifier',
		name: 'shortLinkId',
		type: 'resourceLocator',
		default: '',
		required: true,
